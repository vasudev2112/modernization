...
Author: Automated Java to Python Migration
Date: 2024
"""
...
def main():
    """Sample execution demonstrating the discount calculator."""
    # Test cases
    print(f"Premium customer, $5000: ${DiscountCalculator.calculate_discount(5000, 'PREMIUM')}")
    print(f"Standard customer, $15000: ${DiscountCalculator.calculate_discount(15000, 'STANDARD')}")
    print(f"Unknown customer, $2000: ${DiscountCalculator.calculate_discount(2000, 'UNKNOWN')}")
